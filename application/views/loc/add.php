						...
						<div class="form-group">
							<select name="fk_version_id" id="fk_software" class="form-control">
								...
								foreach($software_versions as $software_version)
								{
									...
									echo '<option software_id="'.$software_version['fk_software_id'].'" value="'.$software_version['id'].'" '.$selected.'>'.$software_version['name'].' '.$software_version['version'].' ('.$software_version['description'].')'.'</option>';
								}
								?>
							</select>
						</div>
