...
<html>
   <head>
      ...
      <!-- Highlightjs -->
      <link rel="stylesheet" href="<?php echo site_url('resources/css/monokai-sublime.css');?>">
      <!-- Theme style -->
      ...
      <script src="<?php echo site_url('resources/js/global.js');?>"></script>
       <!-- Highlightjs -->
       <script src="<?php echo site_url('resources/js/highlight.pack.min.js');?>"></script>
   </head>
   <body class="hold-transition skin-blue sidebar-mini">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="header">
                    <i class="fa fa-cog"></i><span style="padding-left: 5px">Options</span>
                  </li>
                  <li>
                     <a href="<?php echo site_url('import_coverage/import');?>">
                     <i class="fa fa-angle-double-right"></i> <span>Import Coverage Information</span>
                     </a>
                  </li>
                  <!--<li>
                     <a href="#">
      ...
      <script type="text/javascript">
         $(document).ready(function() {
            ...
            <?php 
            if (isset($success_messages) && is_array($success_messages)) {
               foreach ($success_messages as $success_message) {
                  echo 'toastr.success("'.$success_message.'");'.PHP_EOL;
               }
            }
            if (isset($warning_messages) && is_array($warning_messages)) {
               foreach ($warning_messages as $warning_message) {
                  echo 'toastr.warning("'.$warning_message.'");'.PHP_EOL;
               }
            }
            if (isset($error_messages) && is_array($error_messages)) {
               foreach ($error_messages as $error_message) {
                  echo 'toastr.error("'.$error_message.'");'.PHP_EOL;
               }
            }
         ?>
         });
